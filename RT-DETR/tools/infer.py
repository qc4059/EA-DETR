...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', '-c',default="E:/论文写作/欣赏别人的论文/目标检测论文/RT-DETR/RT-DETR-main/rtdetr_pytorch/configs/rtdetr/rtdetr_r50vd_6x_coco.yml", type=str, )
    parser.add_argument('--resume', '-r',default="E:/论文写作/欣赏别人的论文/目标检测论文/RT-DETR/RT-DETR-main/output/rtdetr_r50vd_6x_coco/rtdetr_r50vd_6x_coco_from_paddle.pth", type=str, )
    parser.add_argument('-f', '--im-file',default="E:/Learning/Data/archive/VisDrone2019-DET-val/0000001_07999_d_0000012.jpg", type=str, )
