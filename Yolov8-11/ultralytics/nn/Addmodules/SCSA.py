...
class C2PSASCSA(BaseModule):
    def __init__(
            ...
            init_cfg=None  # 关键修改：添加 init_cfg 参数
    ):
        # 显式传递 init_cfg 给父类
        super(C2PSASCSA, self).__init__(init_cfg=init_cfg)  # 关键修改
...
#     channels = x.shape[1]
#     model = C2f_C2PSASCSA(channels, channels, 1,True)
#     output = model(x)
#     print(output.shape)