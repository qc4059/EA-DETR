...
class YAMLConfig(BaseConfig):
    def __init__(self, cfg_path: str, **kwargs) -> None:
        ...
        # print(type(cfg))   # 此时 cfg 字典类型
        merge_dict(cfg, kwargs)

        # print(cfg)  这个cfg 字典，整合了yaml文件中的所有配置参数、包括训练轮次等一共27个参数

        self.yaml_cfg = cfg 

        self.log_step = cfg.get('log_step', 100)  # get() 返回指定键的值，如果指定的“键”没有值，就返回默认值 eg:100
        self.checkpoint_step = cfg.get('checkpoint_step', 5)
