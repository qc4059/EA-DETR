...
class Criterion(object):
    ...
    def __init__(self, cfg, device, num_classes=80):
        ...
        self.loss_obj_weight = cfg['loss_obj_weight']  # 损失权重 1
        self.loss_cls_weight = cfg['loss_cls_weight']  # 1
        self.loss_box_weight = cfg['loss_box_weight']  # 5
...
#               模型配置参数 设备     20
def build_criterion(cfg, device, num_classes):    #build_criterion函数 它属于 调用的接口
