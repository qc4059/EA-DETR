...
class ELANNet_Tiny(nn.Module):
    ...
    def __init__(self, act_type='silu', norm_type='BN', depthwise=False):
        ...
        # -------------- Network parameters --------------
        ## P1/2
        self.layer_1 = Conv(3, self.feat_dims[0], k=3, p=1, s=2, act_type=act_type, norm_type=norm_type, depthwise=depthwise)  # 卷积三件套
        ## P2/4: Stage-1
        self.layer_2 = nn.Sequential(   
            Conv(self.feat_dims[0], self.feat_dims[1], k=3, p=1, s=2, act_type=act_type, norm_type=norm_type, depthwise=depthwise),  # 卷积三件套           
        ...
        self.layer_3 = nn.Sequential(
            nn.MaxPool2d((2, 2), 2),        # （2,2）卷积核大小  2 指步长     
