...
class YOLOv3(nn.Module):
    def __init__(self,
        ...
        # ------------------- 网络结构 -------------------
        ## 主干网络
        self.backbone, feats_dim = build_backbone(         # feats_dim [256, 512, 1024]
        ...
        ## 颈部网络: 特征金字塔
        self.fpn = build_fpn(cfg=cfg, in_dims=feats_dim, out_dim=int(256*cfg['width']))   # width:1
