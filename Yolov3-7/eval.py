...
def parse_args():
    ...
    # model
    parser.add_argument('-m', '--model', default='yolov7', type=str,
                        help='build yolo')
    

    parser.add_argument('--weight', default="E:\Learning\深度学习\YoLo系列\YOLO书籍-全部源代码\YOLO_Tutorial\weights\VisDrone\yolov7\yolov7_epoch_383.pth",
    ...
    # dataset
    parser.add_argument('--root', default='E:/Learning/Data',
                        help='data root')
    parser.add_argument('-d', '--dataset', default='VisDrone',
                        help='coco, voc.')
